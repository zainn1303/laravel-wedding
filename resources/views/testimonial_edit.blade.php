...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ URL('/testimonial/edit/'.$testi->id) }}">Edit Data</a></li>
    </ol>
...
<div class="page-content">
    <div class="panel">
        ...
        <div class="panel-body">
            <form method="post" action="{{ URl('testimonial/update') }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" value="{{ $testi->id }}" name="id" />
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label class="form-control-label" for="nama">Nama</label>
                        <input type="text" class="form-control <?= ($errors->first('nama') != "") ? 'is-invalid' : ''; ?>" id="nama" name="nama" value="{{ old('nama') ?? $testi->nama }}" />
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control <?= ($errors->first('deskripsi') != "") ? 'is-invalid' : ''; ?>" name="deskripsi">{{ old('deskripsi') ?? $testi->deskripsi }}</textarea>
                        <div class="invalid-feedback">
